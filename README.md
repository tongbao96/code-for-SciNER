...
1. Download the datasets to the `data` directory from the cited papers. 
...
## Notes
1. You may find a suitable encoder at (https://huggingface.co/spaces/mteb/leaderboard) based on your GPU settings.
2. For GPT-4, please apply your API key from (https://openai.com/) and pay for token usage. 
