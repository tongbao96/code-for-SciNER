...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data_path", type=str, default=f"data/{DATA_TYPE}/train_BioBERT_0.70_cls.json")
    parser.add_argument("--val_data_path", type=str, default=f"data/{DATA_TYPE}/valid_BioBERT_0.70_cls.json")
